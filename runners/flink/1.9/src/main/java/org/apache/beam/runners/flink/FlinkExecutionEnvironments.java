...
public class FlinkExecutionEnvironments {
   ...
   * ExecutionEnvironment} depending on the user-specified options.
   */
   ...
   * StreamExecutionEnvironment} depending on the
    ...
    protected JobExecutionResult executeRemotely(StreamGraph streamGraph, List<URL> jarFiles)
      ...
      ClassLoader usercodeClassLoader =
          JobWithJars.buildUserCodeClassLoader(
              jarFiles, globalClasspaths, getClass().getClassLoader(), new Configuration());
